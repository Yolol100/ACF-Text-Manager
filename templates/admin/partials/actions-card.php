		...
		<form method="get" class="wa-acf-ptm-inline-picker" id="wa-acf-ptm-item-picker-form">
			...
			<div class="wa-acf-ptm-inline-row">
				...
				<div class="wa-acf-ptm-inline-field wa-acf-ptm-inline-field-search">
					<label for="wa-acf-ptm-target-search"><?php esc_html_e( 'Zoek een item', 'acf-page-text-manager' ); ?></label>
				...
				<div class="wa-acf-ptm-inline-field wa-acf-ptm-inline-field-select">
					<label for="wa-acf-ptm-target-select"><?php esc_html_e( 'Kies een item', 'acf-page-text-manager' ); ?></label>
					<select id="wa-acf-ptm-target-select" name="target">
						<?php foreach ( $targets as $target ) : ?>
							<option
								...
								data-edit-url="<?php echo esc_attr( (string) ( $target['edit_url'] ?? '' ) ); ?>"
				...
				<div class="wa-acf-ptm-inline-field wa-acf-ptm-inline-field-action wa-acf-ptm-inline-submit-wrap">
					...
					<button type="submit" class="button button-primary wa-acf-ptm-button wa-acf-ptm-inline-submit"><?php esc_html_e( 'Item openen', 'acf-page-text-manager' ); ?></button>
				</div>
			</div>
		</form>
		<?php /* translators: %d: number of found items. */ ?>
		<p class="wa-acf-ptm-support-text"><span id="wa-acf-ptm-target-count"><?php echo esc_html( sprintf( _n( '%d item gevonden', '%d items gevonden', $target_count, 'acf-page-text-manager' ), $target_count ) ); ?></span></p>
	</div>
	...
	<div class="wa-acf-ptm-tab-panel" data-panel="export" id="wa-acf-ptm-panel-export" role="tabpanel" aria-labelledby="wa-acf-ptm-tab-export" tabindex="0" hidden>
		<div class="wa-acf-ptm-action-block">
			...
			<?php if ( empty( $targets ) ) : ?>
				<p class="wa-acf-ptm-support-text"><?php esc_html_e( 'Kies eerst een item voordat je exporteert.', 'acf-page-text-manager' ); ?></p>
			<?php else : ?>
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="wa-acf-ptm-export-form">
				...
				<div class="wa-acf-ptm-export-picker" data-export-picker>
					...
					<div class="wa-acf-ptm-export-selection-panel">
						<div class="wa-acf-ptm-export-selection-topline">
							<div>
								<strong id="wa-acf-ptm-export-target-list-label"><?php esc_html_e( 'Te exporteren items', 'acf-page-text-manager' ); ?> <span id="wa-acf-ptm-export-target-count" class="wa-acf-ptm-export-target-count"></span></strong>
						...
						<div id="wa-acf-ptm-export-target-list" class="wa-acf-ptm-export-checklist" role="group" aria-labelledby="wa-acf-ptm-export-target-list-label">
							<?php foreach ( $targets as $target ) : ?>
								...
								<label class="wa-acf-ptm-export-checklist-item" data-content-scope="<?php echo esc_attr( (string) ( $target['content_scope'] ?? '' ) ); ?>" data-search-text="<?php echo esc_attr( strtolower( (string) $target['title'] . ' ' . (string) ( $target['slug'] ?? '' ) ) ); ?>">
									...
									<?php /* translators: %d: number of import/export fields for this item. */ ?>
		...
		<div class="wa-acf-ptm-action-block">
			...
			<form id="wa-acf-ptm-import-form" enctype="multipart/form-data">
				...
				<div class="wa-acf-ptm-file-shell">
					<input id="wa-acf-ptm-import-file" class="wa-acf-ptm-file-input" type="file" name="import_file[]" multiple accept=".csv,.xlsx,.zip,text/csv,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/zip">
				...
				<p class="wa-acf-ptm-support-text"><?php esc_html_e( 'Maak altijd eerst een importvoorbeeld. Alleen ondersteunde pagina- en berichtvelden worden verwerkt. Het voorbeeld is een dry-run: er wordt pas geschreven nadat je de import uitvoert.', 'acf-page-text-manager' ); ?></p>
				<fieldset class="wa-acf-ptm-import-options">
					...
					<p class="wa-acf-ptm-support-text wa-acf-ptm-danger-text"><?php esc_html_e( 'Let op: media-bestandsnaam wijzigen is een fysieke bestandswijziging. Maak eerst een backup of staging-test en download het rollbackbestand voordat je de import uitvoert.', 'acf-page-text-manager' ); ?></p>
				...
				<div class="wa-acf-ptm-import-buttons">
					<button type="button" id="wa-acf-ptm-preview-button" class="button button-primary wa-acf-ptm-button wa-acf-ptm-button-primary" disabled><?php esc_html_e( 'Importvoorbeeld', 'acf-page-text-manager' ); ?></button>
					<button type="button" id="wa-acf-ptm-run-button" class="button wa-acf-ptm-button" disabled><?php esc_html_e( 'Import uitvoeren', 'acf-page-text-manager' ); ?></button>
				</div>
			</form>
			<div id="wa-acf-ptm-status" class="wa-acf-ptm-status" role="status" aria-live="polite" aria-atomic="true"></div>
			<div id="wa-acf-ptm-preview" class="wa-acf-ptm-preview" hidden aria-live="polite"></div>
