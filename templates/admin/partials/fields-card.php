...
?>
<section class="wa-acf-ptm-card wa-acf-ptm-fields-card">
	<?php
	...
	<?php if ( empty( $selected_target['reference'] ) ) : ?>
		<p><?php esc_html_e( 'Kies links een item om de veldinhoud te tonen.', 'acf-page-text-manager' ); ?></p>
	<?php elseif ( empty( $fields ) ) : ?>
		<p><?php esc_html_e( 'Er zijn geen exporteerbare velden gevonden voor dit item.', 'acf-page-text-manager' ); ?></p>
	<?php else : ?>
		<div class="wa-acf-ptm-fields-toolbar" aria-label="<?php esc_attr_e( 'Veldtools', 'acf-page-text-manager' ); ?>">
			...
			<div class="wa-acf-ptm-toolbar-group wa-acf-ptm-toolbar-group-actions">
				<span class="wa-acf-ptm-toolbar-label"><?php esc_html_e( 'Exportselectie', 'acf-page-text-manager' ); ?></span>
				<div class="wa-acf-ptm-fields-toolbar-actions" role="group" aria-label="<?php esc_attr_e( 'Exportvelden selecteren', 'acf-page-text-manager' ); ?>">
					<button type="button" class="button wa-acf-ptm-toolbar-button" data-export-bulk-action="select-all"><?php esc_html_e( 'Alles selecteren', 'acf-page-text-manager' ); ?></button>
					<button type="button" class="button wa-acf-ptm-toolbar-button wa-acf-ptm-clear-all-fields" data-export-bulk-action="clear-all"><?php esc_html_e( 'Alles wissen', 'acf-page-text-manager' ); ?></button>
				</div>
			</div>
		</div>
			...
			<section class="wa-acf-ptm-field-group" data-field-group="<?php echo esc_attr( sanitize_title( (string) $group['label'] ) ); ?>">
				...
				<div class="wa-acf-ptm-fields-list" role="list" data-target-reference="<?php echo esc_attr( (string) $selected_target['reference'] ); ?>">
					<?php foreach ( $group['fields'] as $index => $field ) : ?>
						...
						?>
						<article class="wa-acf-ptm-field-item<?php echo esc_attr( $is_editable ? ' is-editable' : ' is-readonly' ); ?>" role="listitem" data-field-key="<?php echo esc_attr( (string) ( $field['key'] ?? '' ) ); ?>" data-field-type="<?php echo esc_attr( $field_type ); ?>" data-export-selected="true">
							<div class="wa-acf-ptm-field-head"><div class="wa-acf-ptm-field-head-main"><strong class="wa-acf-ptm-field-title"><?php echo esc_html( $field_label ); ?></strong>
								<button type="button" class="wa-acf-ptm-export-toggle" aria-pressed="true" title="<?php echo esc_attr( sprintf( __( '%s wordt meegenomen in export.', 'acf-page-text-manager' ), $field_label ) ); ?>">
								<span class="wa-acf-ptm-export-toggle-icon" aria-hidden="true">✓</span>
								<span class="screen-reader-text"><?php echo esc_html( sprintf( __( '%s wordt meegenomen in export.', 'acf-page-text-manager' ), $field_label ) ); ?></span>
							</button>
							<?php if ( $is_editable ) : ?>
