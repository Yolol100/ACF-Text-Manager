...
require_once WA_ACF_PTM_PATH . 'includes/admin/traits/page-repository-index-trait.php';
require_once WA_ACF_PTM_PATH . 'includes/admin/traits/page-repository-target-data-trait.php';
require_once WA_ACF_PTM_PATH . 'includes/admin/traits/page-repository-summary-trait.php';
require_once WA_ACF_PTM_PATH . 'includes/admin/traits/page-repository-acf-trait.php';
