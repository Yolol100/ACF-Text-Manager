...
require_once WA_ACF_PTM_PATH . 'includes/admin/traits/admin-actions-export-trait.php';
require_once WA_ACF_PTM_PATH . 'includes/admin/traits/admin-actions-import-trait.php';
require_once WA_ACF_PTM_PATH . 'includes/admin/traits/admin-actions-inline-trait.php';

final class Admin_Actions {
	use Admin_Actions_Export_Trait, Admin_Actions_Import_Trait, Admin_Actions_Inline_Trait;
