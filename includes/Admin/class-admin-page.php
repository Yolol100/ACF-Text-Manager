...
final class Admin_Page {
	...
	public function add_menu(): void {
		$this->hook_suffix = (string) add_menu_page(
			...
			__( 'Tekstbeheer', 'acf-page-text-manager' ),
			Settings::get_manage_capability(),
	...
	public function enqueue_assets( string $hook ): void {
		...
		wp_enqueue_style(
			'wa-acf-ptm-admin',
			WA_ACF_PTM_URL . 'assets/css/admin.css',
			array(),
			WA_ACF_PTM_VERSION
		);
		...
		wp_localize_script(
			...
			array(
				...
				'strings' => array(
					...
					'ajaxTimeout'               => __( 'De server doet te lang over de import. Gebruik een kleinere ZIP of verhoog de PHP max_execution_time/server-timeout.', 'acf-page-text-manager' ),
					...
					'exportNoItemsSelected'    => __( 'Selecteer minstens één pagina of bericht om te exporteren.', 'acf-page-text-manager' ),
					...
					'itemsFoundSingular'       => __( '1 pagina/bericht gevonden', 'acf-page-text-manager' ),
					/* translators: %d: found item count. */
					'itemsFoundPlural'         => __( '%d pagina’s/berichten gevonden', 'acf-page-text-manager' ),
